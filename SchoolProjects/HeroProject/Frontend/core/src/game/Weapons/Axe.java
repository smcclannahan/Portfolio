...
public class Axe extends Weapon {
    ...
    /**
     * Axe Weapon to be used by the player and enemies, uses weapon superclass
<<<<<<< HEAD
...
=======
     ...
     * @param buyPrice    - how much the weapon costs in the shop
     * @param weaponName  - Name of weapon
>>>>>>> 76b1a7a7847a5f518c21cc1246170a3bc083bef3
     */
    public Axe(int pow, int hit, int weaponRange, int buyPrice, String weaponName) {
