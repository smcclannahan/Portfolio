...
public class BowEnemy extends EntitySuper{
     ...
     */
    public BowEnemy(World world, int x, int y, float width, float height, String name, int dmg, int hp, int def){
