...
public class LanceEnemy extends EntitySuper{
     ...
     */
    public LanceEnemy(World world, int x, int y, float width, float height, String name, int dmg, int hp, int def){
