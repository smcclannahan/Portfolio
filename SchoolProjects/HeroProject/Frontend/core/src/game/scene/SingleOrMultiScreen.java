...
public class SingleOrMultiScreen implements Screen {
    ...
    private AxeEnemy enemy;

    /**
     * Mode screen constructor
     * @param game
     * Represents the current game session
     * @param current_player
     * Represents the player playing the game
     */
    public SingleOrMultiScreen(MyGdxGame game, Player current_player){
        this.game = game;
        ...
        buttons = new PlayOptionsButtons(game, this.current_player);
    ...
    /**
     * Renders the players and mode screen actors
     * @param delta
     * delta time variable
     */
    @Override
